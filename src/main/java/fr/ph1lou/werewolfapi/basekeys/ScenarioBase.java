...
public class ScenarioBase {
    ...
    public static final String NO_FALL="werewolf.menu.scenarios.no_fall";
    ...
    public static final String CAT_EYES="werewolf.menu.scenarios.cat_eyes";
    public static final String NO_FIRE_WEAPONS="werewolf.menu.scenarios.no_fire_weapons";
    public static final String TIMBER="werewolf.menu.scenarios.timber";
    public static final String SLOW_BOW="werewolf.menu.scenarios.slow_bow";
    public static final String NO_NETHER="werewolf.menu.scenarios.no_nether";
    public static final String NO_END="werewolf.menu.scenarios.no_end";
    public static final String DOUBLE_JUMP="werewolf.menu.scenarios.double_jump";
    public static final String NO_EXTRA_STONES="werewolf.menu.scenarios.no_extra_stones";
    public static final String BETA_ZOMBIES="werewolf.menu.scenarios.beta_zombies";
    public static final String FINAL_HEAL="werewolf.menu.scenarios.final_heal";
    public static final String SAFE_MINER="werewolf.menu.scenarios.safe_miner";
}